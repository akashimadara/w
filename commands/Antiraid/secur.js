    ...
    description: `Permet de configuré les sécuritées sur le serveur.`,
     async execute(client, message, args,config,emote,footer,color) {
        ...
        async    function update() {
            ...
            return {embeds : [panel], components : [secu, panelselect]}

                }
            message.channel.send(await update()).then(async msg => {
                ...
                const collectorX = msg.createMessageComponentCollector({
                ...
                collector.on("collect", async (c) => {
                    ...
                    if (value === "active") {
                        ...
                        c.reply({ content: `**Toutes les securitées ont étaient activées avec succès**`, ephemeral: true })
                        ...
                        c.reply({ content: `**Toutes les securitées ont étaient désactivées avec succès**`, ephemeral: true })
